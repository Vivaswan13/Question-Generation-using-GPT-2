...
parser.add_argument('--key', type=str, default="quac_869",
...
with open('D:/squash-generation-master/squash/temp/%s/metadata.json' % args.key, 'r') as f:
...
with open('D:/squash-generation-master/squash/temp/%s/input.pkl' % args.key, 'wb') as f:
